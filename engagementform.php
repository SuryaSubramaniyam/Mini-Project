    ...
    if(!empty($email) && ($number))
         {
            $query = "INSERT INTO  order_request (name,number,email,event_date,event_time,type,status) VALUES
                     ('$name','$number',' $email','$eventdate','$eventtime','engagement','Pending')";
                  mysqli_query($conn,$query); 
                  $last_insert_id = mysqli_insert_id($conn);
            
            $query2 = "INSERT INTO engagement (parent_id,venue_place,venue_type,guest_count,menu_type,service_type,additional_service) VALUES
...
<head>
    ...
    <title>Engagement catering Order Form</title>
    <link rel="stylesheet" href="style12.css">
</head>
<body>
    <div class="container">
    <h1>Engagement Catering Order Form</h1><br><br>
        <form action="engagementform.php" method="POST">
            ...
            <label for="additionalservice">Additionalservices:</label><br>
            <div class="form-group">
                <label for="popcorn">
                <input type="checkbox" id="additionalservice" name="additional[]" value="popcorn">popcorn<label><br>
                <label for="popcorn">
                <input type="checkbox" id="icecream" name="additional[]" value="icecream">Ice Cream Stall<label><br>  
                <label for="popcorn">
                <input type="checkbox" id="Fruitsalad" name="additional[]" value="fruitsalad">Fruitsalad<label><br> 
                <label for="popcorn">
